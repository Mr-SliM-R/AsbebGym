...
export function ExerciseDetailPage() {
  ...
  if (!exercise) return <LoadingState label="Loading exercise" />;
    ...
    <div className="space-y-6">
        ...
        <div className="app-panel p-5 sm:p-6">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <div className="surface-panel p-4">
              <div className="text-sm text-slate-500">Recommended sets</div>
              <div className="mt-1 text-2xl font-black text-white">{exercise.recommendedSets}</div>
            </div>
            <div className="surface-panel p-4">
              <div className="text-sm text-slate-500">Recommended reps</div>
        ...
        <div>
          ...
          {exercise.animationCredit ? (
            <div className="mt-3 rounded-lg border border-white/10 bg-white/[0.035] px-3 py-2 text-xs font-semibold text-slate-400">
              Media: {exercise.animationCredit}
            </div>
          ) : null}
        </div>
      </section>
      ...
      <section className="grid gap-6 xl:grid-cols-2">
        <div className="surface-panel p-5">
          <h2 className="text-xl font-black text-white">Step-by-step Instructions</h2>
        ...
        <div className="surface-panel p-5">
          <h2 className="text-xl font-black text-white">Common Mistakes</h2>
